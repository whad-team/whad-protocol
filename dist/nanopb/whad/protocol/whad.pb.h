...
union Message_msg_size_union {char f1[(6 + generic_Message_size)]; char f2[(6 + discovery_Message_size)]; char f3[(6 + ble_Message_size)]; char f7[(6 + phy_Message_size)]; char f0[302];};
#endif
#if defined(generic_Message_size) && defined(discovery_Message_size) && defined(ble_Message_size) && defined(phy_Message_size)
